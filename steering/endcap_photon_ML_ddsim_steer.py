...
SIM.enableGun = True #provide filtered particle genertor input file 
...
SIM.gun.energy = 50000
#SIM.gun.momentumMin = 10000  #to shoot particles with an energy range (1000=1GeV)
#SIM.gun.momentumMax = 100000
...
SIM.gun.thetaMax = 0.5236
SIM.gun.thetaMin = 0.1745
