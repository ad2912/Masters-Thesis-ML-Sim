...
Run this BEFORE deleting reco files and rerunning reconstruction.
...
If all checks pass: your SIM files are solid. Rerun reco with confidence.

Run with:
    source ~/source.sh
    python3 verify_sim_files.py
"""
