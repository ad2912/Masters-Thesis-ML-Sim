...
from Gaudi.Configuration import INFO, FATAL
...
if not reco_args.trackingOnly:
    ...
    # Runs after HighLevelReco (PandoraPFOs must exist).
    # Weights paths are relative to the reconstruction/ directory.

    ISOLATED_LEPTON_COMMON_PARAMETERS = {
        "CosConeLarge": ["0.95"],
        "CosConeSmall": ["0.98"],
        "DirOfISOElectronWeights": ["./IsolatedLeptonTagging/weights/e1e1h_gg_qqqq_250"],
        "DirOfISOMuonWeights": ["./IsolatedLeptonTagging/weights/e2e2h_gg_qqqq_250"],
